 ...
 * @param {import("@aws-sdk/client-cloudwatch-logs").CloudWatchLogsClientConfig} awsConfig CloudWatch client configuration.
 */
export async function getOrCreateLogGroup(logGroupName, awsConfig) {
